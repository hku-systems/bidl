...
public final class BatchBuilder {
	...
	private byte[] createBatch(long timestamp, int numberOfNonces, long seed, int numberOfMessages,
		...
		logger.debug("bidl: in batch builder " + " size: " + size + " numberOfNonces: " + numberOfNonces
				+ " Integer.BYTES * numberOfMessages: " + Integer.BYTES * numberOfMessages + " sigsSize " + sigsSize
				+ " totalMessageSise: " + totalMessagesSize);
